    ...
    return Padding(
      ...
      child: ListView(
        children: [
          ...
          Row(
            children: [
              Expanded(child: _buildStatCard('الغرف المتاحة', '24', Icons.king_bed, Colors.blue)),
          ...
          _buildServiceTile('حجوزات النادي الرياضي', 'مكتمل - 12 حجز اليوم', Icons.fitness_center),
